...
file = File.read('data-bay-to-breakers.json')
b2b_hash = JSON.parse(file)
...
r1 = Race.create(name: b2b_hash["name"], distance: b2b_hash["distance"], image_url:b2b_hash["image"], date: b2b_hash["date"], cost: b2b_hash["cost"])
